...
class InMemoryTaskManagerTest {
    ...
    public void shouldUpdateSubTask(){
        manager.updateSubTask(subtask1, "new SubTask1", "Desription2");
        assertEquals(3, manager.getSubTaskById(subtask1.getId()).getId());
        assertEquals("new SubTask1", manager.getSubTaskById(subtask1.getId()).getName());
        assertEquals("Desription2", manager.getSubTaskById(subtask1.getId()).getDescription());
    }
    @Test
    ...
    public void shouldMoveSubTask(){
        manager.moveSubTaskToDone(manager.getListSubTasks().getFirst().getId());
        assertEquals(Status.DONE, manager.getListSubTasks().getFirst().getStatus());
    }
    @Test
